...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const comments = await commentDB.getAllComments(client, webtoonId);
        res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.READ_COMMENT_SUCCESS, comments));
    } catch (error) {
